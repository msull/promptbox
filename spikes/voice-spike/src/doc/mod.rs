//! Prototype of the transcript document: authoritative committed text plus
//! at most one provisional span, with a single edit history shared by voice
//! and manual edits. All offsets are UTF-8 byte offsets.
//!
...
use crate::events::{SessionId, SpeechEvent, SpeechEventKind, UtteranceId};
