//! The pluggable engine boundary. Called by a feeder/recognition
//! orchestrator, never by an audio callback or the UI directly.
...
pub struct EngineConfig {
    ...
    pub keep_ms: u64,
    /// Whisper needs >= 1 s; windows are zero-padded to this length.
